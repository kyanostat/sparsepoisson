...
class ProposedPredictiveDensity:
    def __init__(self,  eta , dim, r, x, kappa=0.1):
        self.eta = eta  # scalar
        self.dim = dim  #scalar
        self.r = r   # dim vector
        self.x = x  # dim vector 
